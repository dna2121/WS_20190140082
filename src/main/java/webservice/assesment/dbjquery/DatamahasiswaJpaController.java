...
import webservice.assesment.dbjquery.exceptions.NonexistentEntityException;
import webservice.assesment.dbjquery.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("webservice_assesment.dbjquery_jar_0.0.1-SNAPSHOTPU");
